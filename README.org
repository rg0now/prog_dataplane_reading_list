...
devices offering flexible packet processing at high speed
...
and monitoring. The main idea of Smart Packets, which contain programs written in a safe language, is to move management decision points closer to the nodes being managed, as well as to target specific aspects of the node for information rather than conducting an exhaustive collection.
