...
reading list concentrates on progammable switches principally, and only a
marginal attempt is made to address the broader context of Network Function
Virtualization, service chaining, or 5G, where programmable data planes are
primarily applied.
